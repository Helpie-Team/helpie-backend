...
public interface CommunityCommentRepository extends JpaRepository<CommunityComment, Long> {
     ...
     */
    @Query("SELECT DISTINCT c.community FROM CommunityComment c LEFT JOIN FETCH c.community.images WHERE c.userId = :userId AND c.isDeleted = false ORDER BY c.createdAt DESC")
